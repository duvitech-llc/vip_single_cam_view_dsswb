...
Void chains_vipSingleCam_DisplayWbNull_ConnectLinks(chains_vipSingleCam_DisplayWbNullObj *pObj){
       ...
       //Capture_dsswb -> IPCOut_IPU1_0_A15_0_0
       pObj->Capture_dsswbPrm.outQueParams.nextLink = pObj->IPCOut_IPU1_0_A15_0_0LinkID;
       pObj->IPCOut_IPU1_0_A15_0_0Prm.inQueParams.prevLinkId = pObj->Capture_dsswbLinkID;
...
Int32 chains_vipSingleCam_DisplayWbNull_Create(chains_vipSingleCam_DisplayWbNullObj *pObj, Void *appObj){
       ...
       chains_vipSingleCam_DisplayWbNull_SetLinkId(pObj);
       chains_vipSingleCam_DisplayWbNull_ResetLinkPrms(pObj);

       chains_vipSingleCam_DisplayWbNull_SetPrms(pObj);
       chains_vipSingleCam_DisplayWbNull_SetAppPrms(pObj, appObj);

       chains_vipSingleCam_DisplayWbNull_ConnectLinks(pObj);
